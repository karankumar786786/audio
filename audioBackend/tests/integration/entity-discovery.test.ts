...
describe("Entity Discovery Integration", () => {
    ...
    describe("Song Discovery", () => {
        it("should integrate Service and Repository to fetch paginated songs", async () => {
            ...
            mockDb.mockResolvedValueOnce([{ count: 1 }]).mockResolvedValueOnce(mockRows);
    ...
    describe("Playlist Discovery", () => {
        it("should integrate Service and Repository to fetch system playlists", async () => {
            ...
            expect(result[0].name).toBe("Top Charts");
