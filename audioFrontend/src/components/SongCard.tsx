  ...
  const handleToggleFavourite = async (e: React.MouseEvent) => {
    ...
    if (!systemUser?.id) {
      toast.error("Frequency Required", {
        description: "Please sign in to save transients to your library.",
      });
      return;
    }
    ...
    try {
      ...
      if (isFavourite) {
        toast.success("Frequency Released", {
      ...
      toast.error("Sync Error", {
        description: "Failed to update your archive.",
      });
    }
  };
  ...
  return (
    ...
    >
      ...
      <div className="space-y-1.5 px-1">
        <h3 className="font-black text-zinc-100 truncate text-[0.85rem] uppercase italic tracking-tight italic">
          {song.title}
        </h3>
