        ...
        <div className="relative z-20 p-12 flex items-center gap-10">
           ...
           <div className="space-y-4">
              <div className="flex items-center gap-3">
                 <span className="text-[10px] font-black uppercase tracking-[0.2em] text-indigo-400 italic">Vocal Nodes</span>
                 <div className="h-1 w-8 bg-indigo-500 rounded-full" />
              </div>
              <h1 className="text-6xl font-black text-white italic tracking-tighter uppercase leading-none">Artists</h1>
              <p className="text-zinc-500 text-sm font-medium opacity-80 max-w-xl">Curated list of verified acoustic sources within the synchronized network.</p>
           </div>
        </div>
      </header>
      ...
      <section>
        <div className="flex items-center justify-between mb-12 px-2">
           <div className="flex items-center gap-6">
              <h2 className="text-3xl font-black italic tracking-tighter uppercase text-white">Verified Frequencies</h2>
              ...
              >
                <div className="aspect-square bg-zinc-900 rounded-[3rem] border border-white/5 overflow-hidden mb-4 group-hover:border-indigo-500/50 transition-all duration-500 group-hover:scale-[1.02] shadow-xl group-hover:shadow-indigo-500/10">
                   <div className="w-full h-full bg-gradient-to-br from-zinc-800 to-zinc-950 flex items-center justify-center group-hover:from-indigo-900 group-hover:to-zinc-950 transition-colors duration-700">
                      <Mic2 className="text-zinc-800 group-hover:text-indigo-400/30 transition-colors" size={80} />
                   </div>
                ...
                <h3 className="text-center font-black italic uppercase tracking-tighter text-zinc-400 group-hover:text-white transition-colors">{artist.name}</h3>
                <p className="text-center text-[10px] font-black uppercase tracking-[0.2em] text-zinc-600 mt-1 italic">Verified Node</p>
              </Link>
            ))}
          </div>
        )}
