...
export default function ArtistPage() {
  ...
  if (isArtistLoading || isSongsLoading) {
    return <div className="p-20 text-center animate-pulse">Synchronizing Artist Data...</div>;
  }
    ...
    <div className="px-10 pb-20">
      ...
      <header className="relative h-[400px] rounded-[3rem] overflow-hidden mb-12 shadow-2xl">
        ...
        <div className="absolute bottom-0 left-0 p-16 z-20">
          <div className="flex items-center gap-4 mb-4">
             ...
             <span className="text-xs font-black uppercase tracking-[0.2em] text-indigo-300 italic">Verified Frequency</span>
          </div>
          <h1 className="text-7xl md:text-9xl font-black text-white italic tracking-tighter uppercase mb-6">{artist?.name}</h1>
      ...
      <section>
        <div className="flex items-center gap-6 mb-12">
           <h2 className="text-3xl font-black italic tracking-tighter uppercase text-white">Full Discography</h2>
