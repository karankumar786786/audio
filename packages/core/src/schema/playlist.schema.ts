...
export const playlistSchema = z.object({
    ...
    description: z.string().optional().openapi({ description: "Description of the playlist", example: "The best songs of the year" }),
...
export const createPlaylistInput = playlistSchema
    ...
    .extend({
        ...
        description: z.string().optional().openapi({ description: "Description of the new playlist", example: "A mix of upbeat tracks" }),
