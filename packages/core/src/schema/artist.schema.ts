...
export const artistSchema = z.object({
    ...
    coverImageKey: z.string().nullable().optional().openapi({ description: "Imagekit key for the cover image", example: "artists/cover/randhawa.jpg" }),
    bannerImageKey: z.string().nullable().optional().openapi({ description: "Imagekit key for the banner image", example: "artists/banner/randhawa_banner.jpg" }),
